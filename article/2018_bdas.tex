...
\mailPolsl
%\email{\{mkawulok, jnalepa, wdudzik\}@future-processing.com}
%\email{\{michal.kawulok, jakub.nalepa\}@polsl.pl; wdudzik@future-processing.com}
}
\maketitle

%\authorrunning{M. Blocho and J. Nalepa}
%\titlerunning{LCS-Based Selective Route Exchange Crossover for the PDPTW}
...
%\end{abstract}
%\keywords{Complexity analysis, PDPTW, Parallel Memetic Algorithm.}
